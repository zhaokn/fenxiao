...
public class AlipayNotify {
	private static final String HTTPS_VERIFY_URL = "http://pay.919dns.com/api/pay?service=notify_verify&";
	...
	private static boolean getSignVeryfy(Map<String, String> Params,
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			isSign = MD5.verify(preSignStr, sign, alipayKey,
	...
	private static String verifyResponse(String notify_id) {
		...
		String veryfy_url = "http://pay.919dns.com/api/pay?service=notify_verify&partner="
