...
@Scope("prototype")
public class PhoneValidateCodeDaoImpl<T extends PhoneValidateCode> extends
		BaseDaoImpl<T> implements IPhoneValidateCodeDao<T> {
	...
	public PhoneValidateCode getPhoneValidateCode(String phone, String code) {
		...
		PhoneValidateCode phoneValidateCode = (PhoneValidateCode) getSession()
				.createQuery(hql).setString("phone", phone)
