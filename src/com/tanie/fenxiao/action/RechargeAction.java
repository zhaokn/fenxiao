...
public class RechargeAction extends BaseAction {
	...
	public void list() {
		...
		List rechargeList = this.rechargeService.list(hql,
	...
	public void info() {
		...
		try {
			if ((idStr == null) || ("".equals(idStr))) {
				...
				Recharge findrecharge = (Recharge) this.rechargeService
						.findById(Recharge.class, id);
	...
	public void update() {
		...
		try {
			if (this.recharge == null) {
				...
				Recharge findrecharge = (Recharge) this.rechargeService
						.findById(Recharge.class, this.recharge.getId()
								.intValue());
				...
				boolean result = this.rechargeService
						.saveOrUpdate(this.recharge);
